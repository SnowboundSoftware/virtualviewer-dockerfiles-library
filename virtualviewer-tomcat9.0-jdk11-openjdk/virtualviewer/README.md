...
2. Select the `Shared Drives` tab and enable the drive where your `slicense.json` and configuration files are located. Likely `C:\`
...
1. Run `docker run -it -p 8080:8080 -v <PATH TO CLASSES>:/snowbound/classes snowbound/virtualviewer:5.13-tomcat9-jdk11-temurin-latest`.
...
1. Run `docker run -it -p 8080:8080 --env SLICENSE="CONTENTS OF SLICENSE.JSON" snowbound/virtualviewer:5.13-tomcat9-jdk11-temurin-latest`.
   ...
   - Example
      ...
      - `docker run -it -p 8080:8080 --env SLICENSE=$SLICENSE snowbound/virtualviewer:5.13-tomcat9.0-jdk11-openjdk-latest`
2. Open a browser to http://localhost:8080/virtualviewer.
...
3. Run `docker run -it -p 8080:8080 -v <PATH TO CLASSES>:/snowbound/classes snowbound/virtualviewer:5.13-tomcat9-jdk11-temurin-latest`
...
`docker run -it -p 8080:8080 -v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.13.0/classes:/snowbound/classes -v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.13.0/tomcat:/snowbound/tomcat snowbound/virtualviewer:5.13-tomcat9-jdk11-temurin-latest`
...
/vvcache -m 512m --cpus=1 snowbound/virtualviewer:5.13-tomcat9-jdk11-temurin-latest`
...
- Example: `-v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.13.0/classes:/snowbound/classes`
...
- Example: `-v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.13.0/fonts:/snowbound/fonts`
...
- Example: `-v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.13.0/tomcat:/snowbound/tomcat`
...
- Example: `-v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.13.0/user-config:/snowbound/user-config`
...
- Example: `-v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.13.0/WEB-INF:/snowbound/WEB-INF`
