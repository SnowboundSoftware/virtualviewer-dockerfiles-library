...
1. Run `docker run -it -p 8080:8080 -v <PATH TO CLASSES>:/snowbound/classes quay.io/snowbound/virtualviewer:5.1.0-tomcat9.0-jdk11-openjdk`.
...
6. Run `docker run -it -p 8080:8080 -v <PATH TO CLASSES>:/snowbound/classes quay.io/snowbound/virtualviewer:5.1.0-tomcat9.0-jdk11-openjdk`
...
`docker run -it -p 8080:8080 -v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.1.0/classes:/snowbound/classes -v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.1.0/tomcat:/snowbound/tomcat quay.io/snowbound/virtualviewer:5.1.0-tomcat9.0-jdk11-openjdk`
...
/vvcache -m 512m --cpus=1 quay.io/snowbound/virtualviewer-dev:5.1.0-tomcat9.0-jdk11-openjdk`
