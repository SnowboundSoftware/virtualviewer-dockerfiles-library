...
1. Run `docker run -it -p 8080:8080 -v <PATH TO CLASSES>:/snowbound/classes snowbound/virtualviewer:5.13-tomcat9.0-jdk11-latest`.
...
1. Run `docker run -it -p 8080:8080 --env SLICENSE="CONTENTS OF SLICENSE.JSON" snowbound/virtualviewer:5.13-tomcat9.0-jdk11-latest`.
...
3. Run `docker run -it -p 8080:8080 -v <PATH TO CLASSES>:/snowbound/classes snowbound/virtualviewer:5.13-tomcat9.0-jdk11-latest`
...
`docker run -it -p 8080:8080 -v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.13.0/classes:/snowbound/classes -v /home/dpowers/git/virtualviewer-tomcat9.0-jdk11-openjdk_v5.13.0/tomcat:/snowbound/tomcat snowbound/virtualviewer:5.13-tomcat9.0-jdk11-latest`
...
/vvcache -m 512m --cpus=1 snowbound/virtualviewer:5.13-tomcat9.0-jdk11-latest`
